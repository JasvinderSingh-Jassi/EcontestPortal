...
<div class="login-form">
    <form  method="post">
		...
		<br/>
            <input type="password" id="password1" class="form-control" placeholder="Enter new password" required="required">
			<span id="password_error" class="field_error"></span>
			<br/>
			
			<input type="password" id="conf_password1" class="form-control" placeholder="Confirm new password" required="required">
