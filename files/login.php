...
<p style="color:whitesmoke"><b>Don't have an account?</b></p>
	 <input type="button"  value="SIGNUP" class="btn-login" onclick="window.location.href='register.php'" />
</br>
 </form>
	...
	jQuery.ajax({
		url:'https://minorprojectsilicon.000webhostapp.com/files/check.php',
		type:'post',
		...
		success:function(result) {
			...
			window.location='https://minorprojectsilicon.000webhostapp.com/files'+result.split(":")[1]+'/dashboard.php?id='+result.split(":")[1];
			}
			if(result=='not_exist'){
