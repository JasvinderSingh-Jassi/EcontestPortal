                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="dashboard.php?id=<?php  echo "$id11" ?>"><span class="glyphicon glyphicon-dashboard" aria-hidden="true"></span> Dashboard</a></li>
                         <li><a href="login.php?id=<?php  echo "$id11" ?>"><span class="glyphicon glyphicon-login" aria-hidden="true"></span> Login &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
              </div><!-- /.container-fluid -->
        </nav>
 ...
 <input type="button"  value="REGISTER" class="btn-login" onclick="send()" />
	...
	jQuery.ajax({
		...
		success:function(result) {
            if(result=='empty'){
				jQuery('#password_error').html('Please enter your name & phone_no');
			}
			if(result=='not_empty'){
					window.location='verify1.php'
			}
